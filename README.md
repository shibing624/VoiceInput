...
下载最新的 [VoiceInput.dmg](https://github.com/shibing624/VoiceInput/releases/download/v1.0.0/VoiceInput.dmg)，双击打开，拖动 `VoiceInput.app` 到 `Applications` 文件夹即可。
...
- **GitHub Issues** — [提交 issue](https://github.com/shibing624/VoiceInput/issues)
...
- [yetone/voice-input-src](https://github.com/yetone/voice-input-src) — 一句话生成VoiceInput的 Prompt
